...
#define TAILLE_CASE 70 // La taille d'une case //la valeur initiale était de 108

#define LARGEUR ((9+1)*TAILLE_CASE)  // La taille horizontale de la fenêtre // (9*TAILLE_CASE+1) 
#define HAUTEUR (9*TAILLE_CASE+1) // La taille verticale   de la fenêtre // ((9+1)*TAILLE_CASE)
